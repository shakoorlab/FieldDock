...
export var testCalculations = function testCalculations(_ref) {
  ...
  describe('Method: dateWithTimezone', function () {
    it('should parse ISO strings', function () {
      if (adapter.isTimezoneCompatible) {
        var test = function test(timezone) {
          var expectedTimezones = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : timezone;
          [adapterTZ, adapterFr].forEach(function (instance) {
            var dateWithZone = instance.dateWithTimezone(TEST_DATE_ISO_STRING, timezone);
    ...
    it('should parse locale strings', function () {
      if (adapter.isTimezoneCompatible) {
        var test = function test(timezone) {
          [adapterTZ, adapterFr].forEach(function (instance) {
            var dateWithZone = instance.dateWithTimezone(TEST_DATE_LOCALE_STRING, timezone);
    ...
    it('should parse undefined', function () {
      if (adapter.isTimezoneCompatible) {
        var testTodayZone = function testTodayZone(timezone) {
          var dateWithZone = adapterTZ.dateWithTimezone(undefined, timezone);
  ...
  it('Method: getTimezone', function () {
    if (!adapter.isTimezoneCompatible) {
      return;
    }
    var testTimezone = function testTimezone(timezone) {
      var expectedTimezone = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : timezone;
